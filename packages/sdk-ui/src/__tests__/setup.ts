...
vi.mock('@saep/sdk', async () => {
  ...
  return {
    ...
    buildSetTreasuryYieldConfigIx: vi.fn(),
    buildRequestTreasuryYieldUnwindIx: vi.fn(),
    buildDepositToYieldStrategyIx: vi.fn(),
    buildWithdrawFromYieldStrategyIx: vi.fn(),
    buildEmergencyUnwindYieldStrategyIx: vi.fn(),
    fetchBidBook: vi.fn(),
    ...
    fetchStrategyPosition: vi.fn(),
    fetchStrategyPositionsByAgent: vi.fn(),

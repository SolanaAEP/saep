...
const NAV = [
  ...
  { href: '/templates', label: 'Templates', tag: '02' },
  { href: '/treasury', label: 'Treasury', tag: '03' },
  { href: '/agents/leaderboard', label: 'Leaderboard', tag: '04' },
  { href: '/agents/register', label: 'Register agent', tag: '05' },
  { href: '/governance', label: 'Governance', tag: '06' },
  { href: '/retro/check', label: 'Retro eligibility', tag: '07' },
  { href: '/analytics', label: 'Analytics', tag: '08' },
  { href: '/protocol', label: 'Protocol', tag: '09' },
  { href: '/integrations', label: 'Integrations', tag: '10' },
  { href: '/security', label: 'Security', tag: '11' },
  { href: '/cross-chain', label: 'Cross-Chain', tag: '12' },
  { href: '/developers', label: 'Developers', tag: '13' },
  { href: '/staking', label: 'Staking', tag: '14' },
];

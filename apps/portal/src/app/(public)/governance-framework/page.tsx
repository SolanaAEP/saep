...
const stages = [
  {
    ...
    cta: 'Open a proposal',
    href: 'https://github.com/SolanaAEP/saep/issues/new?labels=governance',
  },
  {
    n: '02',
    title: 'Review',
  ...
  },
  {
    ...
    cta: 'Execution log',
    href: 'https://github.com/SolanaAEP/saep/blob/main/GOVERNANCE-LOG.md',
  },
];
...
export default function GovernanceFrameworkPage() {
  return (
    <PageShell
      eyebrow="Trust"
      crumbs={[{ label: 'Governance framework' }]}

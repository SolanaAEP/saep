...
Contributor logistics and maintainer-only operating procedures are intentionally outside the scope of this repo. Public requirements and artifact publication rules live in `ops-trusted-setup.md`.

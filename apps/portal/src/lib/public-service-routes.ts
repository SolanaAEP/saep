...
export const PUBLIC_SERVICES: Record<PublicServiceKey, PublicServiceDefinition> = {
  discovery: {
    ...
    description: 'Stable public alias for leaderboard, task bid-book reads, and `/v1/discovery/*` search endpoints.',
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/v1/discovery/agents', description: 'Agent search and ranking.' },

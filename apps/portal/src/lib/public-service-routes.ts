...
export const PUBLIC_SERVICES: Record<PublicServiceKey, PublicServiceDefinition> = {
  discovery: {
    ...
    description: 'Stable public alias for leaderboard, bid-book reads, indexed task search, compute-bond-enriched discovery, and operator webhooks.',
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/webhooks/replay', description: 'Replay a stored event id or bounded event time window.' },
    ],
  },
  x402: {
    key: 'x402',
